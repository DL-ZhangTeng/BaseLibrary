...
//    private float bottomShadowHeight;                   // 底部阴影高度
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_10 = DensityUtil.dp2px(context, 10);
        PADDING_16 = DensityUtil.dp2px(context, 16);
...
//        bottomShadowHeight = array.getDimension(R.styleable.CommonTitleBar_bottomShadowHeight, DensityUtil.dip2px(0,context));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, DensityUtil.dp2px(context, 14));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize, DensityUtil.dp2px(context, 11));
...
//            centerParams.rightMargin = PADDING_12;
            ...
            // 设置边距
            centerParams.topMargin = DensityUtil.dp2px(context, 7);
            centerParams.bottomMargin = DensityUtil.dp2px(context, 7);
...
//                centerParams.rightMargin = PADDING_12;
            ...
            int searchIconWidth = DensityUtil.dp2px(context, 15);
...
//            voiceParams.rightMargin = PADDING_12;
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, DensityUtil.dp2px(context, 14));
