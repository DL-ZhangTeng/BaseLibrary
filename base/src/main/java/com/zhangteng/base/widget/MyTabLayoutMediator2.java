...
public final class MyTabLayoutMediator2 {
    ...
    public interface TabConfigurationStrategy {
         ...
         * MyTabLayout.Tab#setText(CharSequence)}, but any form of styling can be applied.
         *
         * @param tab      The Tab which should be configured to represent the title of the item at the given
         *                 position in the data set.
         * @param position The position of the item within the adapter's data set.
         */
        void onConfigureTab(@NonNull MyTabLayout.Tab tab, int position);
    }

    public MyTabLayoutMediator2(
            @NonNull MyTabLayout tabLayout,
    ...
    /**
     * Returns whether the {@link MyTabLayout} and the {@link ViewPager2} are linked together.
     */
     ...
     *
     * <p>This class stores the provided MyTabLayout weakly, meaning that you can use {@link
    ...
    public static class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            MyTabLayout tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
    ...
    public static class ViewPagerOnTabSelectedListener implements MyTabLayout.OnTabSelectedListener {
        ...
        public ViewPagerOnTabSelectedListener(ViewPager2 viewPager, boolean smoothScroll) {
            this.viewPager = viewPager;
            this.smoothScroll = smoothScroll;
        }
